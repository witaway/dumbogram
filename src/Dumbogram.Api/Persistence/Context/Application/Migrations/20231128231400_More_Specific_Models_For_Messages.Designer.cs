...
namespace Dumbogram.Api.Database.Migrations.Application
{
    ...
    [Migration("20231128231400_More_Specific_Models_For_Messages")]
    partial class More_Specific_Models_For_Messages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dumbogram.Models.Messages.SystemMessages.EditedDescriptionSystemMessage", b =>
                {
                    b.HasBaseType("Dumbogram.Models.Messages.SystemMessages.SystemMessage");
                    ...
                    b.HasDiscriminator().HasValue("EditedDescriptionSystemMessage");
                });

            modelBuilder.Entity("Dumbogram.Models.Messages.SystemMessages.EditedTitleSystemMessage", b =>
                {
                    b.HasBaseType("Dumbogram.Models.Messages.SystemMessages.SystemMessage");
                    ...
                    b.ToTable("messages", t =>
                        {
                            t.Property("NewContent")
                                .HasColumnName("edited_title_system_message_new_content");
                        });

                    b.HasDiscriminator().HasValue("EditedTitleSystemMessage");
                });

            modelBuilder.Entity("Dumbogram.Models.Messages.SystemMessages.JoinedSystemMessage", b =>
                {
                    b.HasBaseType("Dumbogram.Models.Messages.SystemMessages.SystemMessage");

                    b.HasDiscriminator().HasValue("JoinedSystemMessage");
                });

            modelBuilder.Entity("Dumbogram.Models.Messages.SystemMessages.LeftSystemMessage", b =>
                {
                    b.HasBaseType("Dumbogram.Models.Messages.SystemMessages.SystemMessage");

                    b.HasDiscriminator().HasValue("LeftSystemMessage");
                });
