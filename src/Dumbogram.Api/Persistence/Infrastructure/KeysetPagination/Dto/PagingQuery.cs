...
namespace Dumbogram.Api.Persistence.Infrastructure.KeysetPagination.Dto;

public class PagingQuery : ICloneable
{
    [FromQuery(Name = "take")] public int? Take { get; set; }

    [FromQuery(Name = "order")] public string? Order { get; set; } = null!;

    [FromQuery(Name = "first")] public bool First { get; set; }

    [FromQuery(Name = "last")] public bool Last { get; set; }

    [FromQuery(Name = "prev_page_token")] public string? PrevPageToken { get; set; }

    [FromQuery(Name = "next_page_token")] public string? NextPageToken { get; set; }
